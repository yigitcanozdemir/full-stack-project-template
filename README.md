...
│
├── docs               <- Project documentation and setup resources.
│   └── prompts        <- One-time prompts for configuring coding agents.
...
## About the `docs/prompts/` Directory

The files in `docs/prompts/` — `AGENTS.md`, `OPTIMIZATION.md`, and `SECURITY.md` — are **not agent configuration files**. They are prompt documents meant to be given to a coding agent **at project creation time** to generate configuration files such as `AGENTS.md`, `CLAUDE.md`, skill files, or agent rules tailored to your project.
